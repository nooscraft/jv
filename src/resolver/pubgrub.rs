...
pub use crate::resolver::transitive::{resolve_transitive as fallback, Resolution, ResolveOptions};
...
impl Default for MavenPubGrubProvider {
    fn default() -> Self {
        Self::new()
    }
}
...
impl Default for RealMavenProvider {
    fn default() -> Self {
        Self::new()
    }
}
